  ...
  return (
    <div className="min-h-screen bg-cream-100 flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="font-display text-3xl font-bold text-bark-900 mb-3">Payment Cancelled</h1>
        <p className="text-bark-700/70 mb-8">
          ...
          <a href="tel:+27694274833" className="text-ember-600 font-semibold">069 427 4833</a>.
        </p>
        <Link
          href="/"
